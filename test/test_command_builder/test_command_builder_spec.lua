...
local command_builder = require("neotest-scala.test_command_builder")

describe("Test Command Builder", function()
    ...
    describe("build_command", function()
        ...
        async.it("should prepare a test runner command for a single Test Suite (Munit)", function()
            local expected =
                "scala-runner --runner bloop --project foo.test --framework munit --only foo.bar.FooTests --to /tmp --kind namespace"
