...
//       if args.length == 1 && args.head.startsWith("@") then {
...
//       * [-s testClassName ...] [-t testMethodName ...] or new-style args file
//       * (passed via @filename).
//       */
...
//
//     val spec = specInstance.aspects.foldLeft(
//       FilteredSpec(specInstance.spec, testArgs)
//     )(_ @@ _) @@
//       TestAspect.fibers @@
...
//       TestLogger.logLine(render(executedSpec).mkString("\n"))
//
...
//           val id = idCounter.updateAndGet(_ + 1)
//           val results = DefaultTestReporter.render(
//             executedSpec,
...
//
//   private def onTestFailed(
//       label: String,
//       id: Int,
//       res: List[RenderedResult[String]]
//   ) = res match {
//     case r :: Nil =>
//       tc(
...
//     case _ =>
//       tc(
//         s"testFailed name='${escapeString(label)}' message='Assertion failed' nodeId='$id'"
//       )
//   }
//
